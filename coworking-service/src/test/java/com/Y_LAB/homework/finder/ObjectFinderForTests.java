...
public class ObjectFinderForTests {
    ...
    @SneakyThrows
    public void setReservationIdFromDB(Reservation reservation, Connection connection) {
    ...
    @SneakyThrows
    public void setReservationPlaceIdFromDB(ReservationPlace reservationPlace, Connection connection) {
