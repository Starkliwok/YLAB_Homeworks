...
public class ReservationServiceImpl implements ReservationService {
    ...
    @Auditable
    @Override
    public Reservation getUserReservation(long id, long userId) throws ObjectNotFoundException {
        Reservation reservation = reservationDAO.getReservation(id);
    ...
    @Auditable
    @Override
    public void deleteUserReservation(long id, long userId) throws ObjectNotFoundException {
        Reservation reservation = reservationDAO.getReservation(id);
        if(reservation == null || reservation.getUserId() != userId) {
            throw new ObjectNotFoundException("Reservation with id " + id + " does not exists");
        }
