...
/**
 * Класс содержит константы для приложения
 * @author Денис Попов
 * @version 1.0
 */
public class ApplicationConstants {
    ...
    /** Константа значения ключа username в файле properties*/
    public static final String PROPERTIES_USERNAME_KEY = "username";

    /** Константа значения ключа password в файле properties*/
    public static final String PROPERTIES_PASSWORD_KEY = "password";
